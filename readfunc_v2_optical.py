...
# Configuration
Global_Feature_Type = FeatureType.OPTICAL_MULTI # Feature type: RGB, OpticalFlow, multi OpticalFlow images

Flag_data_aug = False #Double training data (Only support RGB features)
Flag_Visual = False #Showing sample pictures after feature extraction
...
def readData(feature_type, train_eval_ratio):
    ...
    elif feature_type == feature_type.OPTICAL_MULTI:
        gTrainFilters = './Data/training_optical/*.*'
        gTestFilters = './Data/testing_optical/*.*'
